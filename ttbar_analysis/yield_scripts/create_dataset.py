...
#TODO: names better with a dictionary that is in another library?
#TODO: add more features to the latex table (efficiency from counters and
tables with the rescaled number of events)
"""
